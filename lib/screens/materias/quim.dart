...
class QuiPage extends StatefulWidget {
  const QuiPage({super.key});

  @override
  _QuiPageState createState() => _QuiPageState();
}

class _QuiPageState extends State<QuiPage> {
  ...
  Future<void> fetchData() async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        // Filtra apenas os vídeos com a categoria "Química"
        videoData = data.where((produto) => produto["categoria"] == "Química").toList();
      });
    } else {
